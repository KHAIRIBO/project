      ...
      >
        ...
        <div className="mt-6 flex flex-col items-center">
          ...
          <button 
            ...
            className="w-full bg-white border border-blue-100 text-slate-800 font-medium py-3 px-6 rounded-full transition-all duration-300 hover:bg-blue-50 shadow-sm flex items-center justify-center gap-2"
          >
