  ...
  return (
    <div className="flex items-center justify-center min-h-[70vh] animate-fade-in">
      ...
      >
        ...
        {error && <div className="mb-4 text-red-500 text-sm text-center bg-red-100/50 p-2 rounded">{error}</div>}
        ...
        <div className="mt-6 flex flex-col items-center">
          <p className="text-sm text-textMuted mb-4">— Or sign up with —</p>
          <button 
            type="button" 
            onClick={handleGoogleSignIn}
            className="w-full bg-white border border-green-200 text-slate-800 font-medium py-3 px-6 rounded-full transition-all duration-300 hover:bg-green-50 shadow-sm flex items-center justify-center gap-2"
          >
